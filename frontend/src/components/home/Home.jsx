      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-10 md:gap-20 p-10">
        ...
        >
          ...
          <div className="w-full h-64 max-w-sm text-center bg-gray-700 md:w-80 bg-opacity-70 rounded-b-3xl">
            ...
            <p className="text-sm text-white md:text-base">
              Connect with experienced pandits for authentic Vedic ceremonies.
              Book virtual or in-person rituals for house warmings, weddings,
              naming ceremonies, and daily pujas with knowledgeable
              practitioners.
            </p>
          </div>
        </div>
