...
class Story extends Phaser.Scene {
    ...
    nextScene() {
        ...
        if (this.currentSceneIndex < this.scenes.length) {
            ...
            this.subtitleText = this.add.text(this.cameras.main.centerX, this.cameras.main.height - 50, subtitleText, {
                font: '24px Arial',
                fill: '#ffffff',
                align: 'center',
            ...
            if (this.scenes[this.currentSceneIndex].audio) {
                this.currentAudio = this.sound.add(this.scenes[this.currentSceneIndex].audio); // Store the current audio
